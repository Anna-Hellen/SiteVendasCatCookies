  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="cadastraprodutos.html">
              <span data-feather="shopping-cart" class="align-text-bottom"></span>
               Cadastrar Produtos
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="alteraproduto.html">
              <span data-feather="shopping-cart" class="align-text-bottom"></span>
              Alterar Produtos
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="excluirproduto.html">
              <span data-feather="shopping-cart" class="align-text-bottom"></span>
              Excluir Produtos
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤRelatório de Produtos</h1>
      </div>
      <h2 class="text-center">Veja o relatório de todos os produtos cadastrados</h2>
...
<script src="customProduto.js"></script>
