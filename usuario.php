  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="alterausuario.html">
              <span data-feather="users" class="align-text-bottom"></span>
              Alterar Usuários
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="excluirusuario.html">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤRelatório de Usuários</h1>
      </div>
      <h2 class="text-center">Veja o relatório de todos os usuários cadastrados</h2>
...
<script src="customUsuario.js"></script>
